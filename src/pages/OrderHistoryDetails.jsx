                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><h6 className="td-color px-2" style={{ fontWeight: 400, lineHeight: "63px", fontSize: "14px", color: '#059fe2' }}>₹1000.00</h6></td>
                                            {/* <td> */}
                                        ...
                                        <tr>
                                            ...
                                            {/* <div className="num" > */}
                                                ...
                                                {/* <button style={{border: 'none', outline: 'none', backgroundColor: 'white', color: '#059fe2', fontSize: "17px", fontWeight: 700}}>+</button> */}
                                            {/* </div> */}
                                            <td><h6 className="td-color px-2" style={{ fontWeight: 400, lineHeight: "63px", fontSize: "14px", color: '#059fe2' }}>₹63.00</h6></td>
                                            {/* <td>  */}
                                            {/* <a href="javascript:void(0)" class="icon" style="color:#777777;padding: 0px 3px; line-height: 63px;"> <img src="/images/edit.png" alt="404"> </a> */}
                                            {/* <a href="javascript:void(0)" className="icon" style={{color: '#777777', padding: '0px 3px', lineHeight: "63px"}}><img src="/images/delete.png" alt={404} /></a></td> */}
                                        </tr>
            ...
            <span className="family" style={{fontWeight: 500, color: '#8F9091',fontSize:'12px'}}>COD</span>
              ...
              <span style={{color: '#D83043', fontWeight: 500,fontSize:"10px"}}>Remove</span>
                                ...
                                <div className="firstrow px-3 d-flex justify-content-between" style={{ padding: "5px 0px" }}>
                                    ...
                                    <span style={{ fontWeight: 500, color: '#059fe2', fontSize: "12px", }}>₹500.00   <hr color="red" style={{  width: '100%', marginLeft: '3px', margin: 0, position: 'relative', top: 15, opacity: 1, color: '#2B2A29', background: '#2B2A29', }} />
                                    </span>
                                </div>
