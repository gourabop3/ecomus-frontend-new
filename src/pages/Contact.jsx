...
const Contact = () => {
  ...
  const sendinfo = async (res,action) =>{
const response = await postcontact(res);
console.log("respnse of contact form",response);
        ...
        <div className="info-column col-md-4 col-sm-12 col-xs-12">
          <div className="inner-column">
            ...
            <ul className="list-info">
              ...
              <li><i className="far fa-envelope" />Support@webmastery.com</li>
              <li><i className="fas fa-phone" />1-234-567-890 <br /></li>
            </ul>
