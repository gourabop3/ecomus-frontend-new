                                      ...
                                      <div className="detail-title">
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            >
                                              {" "}
                                              ₹{item?.stockrecords__price}{" "} {item.stock_record?.discount == 0 ? '' : <span style={{fontSize: '10px',color: '#c1c1c1',lineHeight: '20px',textDecoration: 'line-through',paddingLeft:'3px',fontWeight:'400'}}>₹{item.stock_record?.mrp}</span>}{item.stock_record?.discount == 0 ? '' : <span style={{fontSize: '10px',color: '#059fe2',lineHeight: '20px',paddingLeft:'3px',fontWeight:'400'}}>{item.stock_record?.discount_type == "amount" ? `(₹${item.stock_record?.discount} off)` : `(${item.stock_record?.discount} %off)`}</span>}
                                            </div>
